...
$view = "SELECT * FROM tb2_records ORDER BY p_id DESC";
...
if($_GET['id']){
    $Tdi = $_GET['id'];
     $delete = " delete from tb2_records where tb2_records.p_id = $Tdi";
$delete_exe =    mysqli_query($connection,$delete);
    if($delete_exe){
        echo "<script>alert('data deleted')</script>";
       ?>
<meta http-equiv="refresh" content="1 ; url=records.php?id"> 
...
<style>
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Previous records</h3>
					...
					<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
							<div class="panel-body no-padding">
								<table class="table table-striped">
									<thead>
										 <tr>
                                        <td colspan="9" style="background-color:deepskyblue;color:white;text-align:center;"> 
...
<td>".$row['p_contact']."</td>
<td>".$row['p_address']."</td>
<td><a href='records.php?id=$di' onclick='return checkdelete()' >delete</a></td>
 </tr>";
   }
    ?>
									</tbody>
